...
def task2():
    ...
    query =  '''
        ...
        SELECT classification, COUNT FROM cls_temp
        WHERE COUNT >= 100
        ORDER BY COUNT desc;''' 
...
def task3():
    ...
    # TODO task 3
    query = '''
        SELECT info ->>'nationality' AS nationality,COUNT(*) FROM moma_artists
...
def task4():
    ...
    # TODO task 4
    query = '''
        SELECT UPPER(info ->>'gender') AS gender,COUNT(*) FROM moma_artists
